...
import { apiService, AccessPoint, APDetails, APStation } from '../services/api';
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="font-medium">{apDetails.channel || 'N/A'}</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="font-medium">{apDetails.txPower ? `${apDetails.txPower} dBm` : 'N/A'}</p>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 gap-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{apDetails.displayName || 'N/A'}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">{apDetails.firmware || 'N/A'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Location:</span>
              <span className="font-medium">{apDetails.location || 'N/A'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Site:</span>
              <span className="font-medium">{apDetails.site || 'N/A'}</span>
            </div>
          </div>
        </CardContent>
      </Card>
